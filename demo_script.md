...
Good morning. Our project is `SkillPulse`, built around the idea of `Skill Decay and Dynamic Career Arbitrage`.

The problem we are solving is simple. Students usually learn from static syllabi, but the job market changes much faster. A skill that was enough a few months ago may no longer be enough today, and students often do not know what micro-skills they should learn next.

Existing career tools mostly give generic course recommendations. They do not tell students which skills are rising right now, which skills are losing value, and most importantly, how to prove the missing skill through a project.

That is where SkillPulse is different.

Our system analyzes recent job postings for a specific role and city, compares them with a student's profile, and generates three outputs:

1. matched skills
2. missing high-demand skills
3. a proof-oriented roadmap with a mini-project idea
...
In short, SkillPulse does not just tell students what to learn. It tells them what changed, what matters now, and what to build next to stay employable.
